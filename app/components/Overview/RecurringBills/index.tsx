  ...
  return (
    <Card className='p-[32px] flex flex-col gap-4 shadow-none flex-grow flex-1 h-full'>
      ...
      <div className='grid grid-cols-1 gap-4 mt-2'>
        {/* Paid Bills */}
        <div className='flex items-center justify-between p-4 rounded-lg bg-[#F8F4F0] border-l-4 border-blue-400'>
        ...
        {/* Total Upcoming */}
        <div className='flex items-center justify-between p-4 rounded-lg bg-[#F8F4F0] border-l-4 border-orange-400'>
          <span className='font-semibold text-[16px] text-gray-900'>
            Total Upcoming
          </span>
          <span className='font-bold text-[16px] text-gray-900'>
        ...
        {/* Due Soon */}
        <div className='flex items-center justify-between p-4 rounded-lg bg-[#F8F4F0] border-l-4 border-green-400'>
          <span className='font-semibold text-[16px] text-gray-900'>
            Due Soon
          </span>
          <span className='font-bold text-[16px] text-gray-900'>
